...
def main(args):
	...
	if args.exp in range(0,4) or args.exp in range(33,39) or args.exp in range(70,80):
	...
	if args.exp == 73: ptraining_fn(nn.init_baseline(embedded_path = 'model/between_embedded_32.hdf5'), model_name='baseline')
	if args.exp == 74: ptraining_fn(nn.init_FCNN(embedded_path = 'model/between_embedded_32.hdf5'), model_name='FCNN')
	if args.exp == 75: ptraining_fn(nn.init_bilstm(embedded_path = 'model/between_embedded_32.hdf5'), model_name='bilstm')
	if args.exp == 76: ptraining_fn(nn.init_LTRCNN(embedded_path = 'model/between_embedded_32.hdf5'), model_name='LTRCNN')
	if args.exp == 77: ptraining_fn(nn.init_lstm(embedded_path = 'model/between_embedded_32.hdf5'), model_name='lstm')
	if args.exp==78: ptraining_fn(nn.init_cnn_bilstm(embedded_path = 'model/between_embedded_32.hdf5'), model_name='conv_bilistm' )
	...
	if args.exp == 57: ptraining_fn(nn.init_baseline(embedded_path = 'model/between_embedded_32.hdf5'), model_name='baseline')
	if args.exp == 58: ptraining_fn(nn.init_FCNN(embedded_path = 'model/between_embedded_32.hdf5'), model_name='FCNN')
	if args.exp == 59: ptraining_fn(nn.init_bilstm(embedded_path = 'model/between_embedded_32.hdf5'), model_name='bilstm')
	if args.exp == 60: ptraining_fn(nn.init_LTRCNN(embedded_path = 'model/between_embedded_32.hdf5'), model_name='LTRCNN')
	if args.exp==61: ptraining_fn(nn.init_conv_bilistm_2(cnn_unit=64, embedded_path = 'model/between_embedded_32.hdf5'), model_name='conv_bilistm' )
