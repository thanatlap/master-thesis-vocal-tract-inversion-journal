...
def simulate_speaker_from_given_ratio(
	speaker_ratio, 
	predefined_syllables, 
	syllable_labels,
	adult_header_file,
	infant_header_file,
	speaker_tail_file,
	...
	'''
	 ...
	 speaker_ratio -> a list of ratio. ex: [0.0, 0.1, 0.2]
	'''
	for sid, scale in enumerate(speaker_ratio):
		simulate_speaker(scale, sid, 
			adult_header_file=adult_header_file, 
			infant_header_file=infant_header_file, 
