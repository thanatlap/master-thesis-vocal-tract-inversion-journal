...
def label_transform(labels, invert=False):
	return descale_labels(add_WC_param(labels)) if invert else delete_WC_param(scale_labels(labels))
...
# Calculate formant
def get_formant(sound_sets, save_dir, praatEXE, label, split_range=40, is_disyllable = False):
	...
	for idx, file in enumerate(sound_sets):
		...
		if is_disyllable:
			F1.append(formantData[int(formantData.shape[0]/2)-split_range:int(formantData.shape[0]/2),1])
			F1.append(formantData[int(formantData.shape[0]/2):int(formantData.shape[0]/2)+split_range,1])
			F2.append(formantData[int(formantData.shape[0]/2)-split_range:int(formantData.shape[0]/2),2])
			F2.append(formantData[int(formantData.shape[0]/2):int(formantData.shape[0]/2)+split_range,2])
			F3.append(formantData[int(formantData.shape[0]/2)-split_range:int(formantData.shape[0]/2),3])
			F3.append(formantData[int(formantData.shape[0]/2):int(formantData.shape[0]/2)+split_range,3])
		else:
			F1.append(formantData[5:45,1])
			F2.append(formantData[5:45,2])
			F3.append(formantData[5:45,3])
...
def export_format_csv(label_name, formant_dir, sel_point = 13, disyllable = False):
	...
	df.to_csv(os.path.join(formant_dir,'data_point.csv'))
