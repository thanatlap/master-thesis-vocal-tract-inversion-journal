...
def formant_chart(datapoint_df,  dir_path, experiment_num, is_disyllable):
...
def generate_eval_result(experiment_num, is_disyllable):

	dir_path = 'result/eval_'+str(experiment_num)+'/formant/'
	...
	formant_chart(datapoint_df,  dir_path, experiment_num, is_disyllable)
