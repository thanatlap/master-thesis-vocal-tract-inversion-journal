...
python preprocess.py training ..\data\d_dataset_t3 di --output_path=prep_data_v3 --augment_samples=0.25 --resample_rate=16000 --label_normalize=5 --feature_normalize=4 --split_size=0.15
...
python predicting.py ..\data\d_records\d_record_set_2 prep_data_2 16_senet_data_2_fix_mfcc_20.h5 di --label_normalize=3