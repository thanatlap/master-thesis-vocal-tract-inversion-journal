...
rem python training.py 77
rem python preprocess.py predict ..\data\d_records\d_record_set_2 di --output_path=prep_data --resample_rate=16000 --feature_normalize=4
python predicting.py ..\data\d_records\d_record_set_2 prep_data 77_senet.h5 di --label_normalize=3
"result\predict_77\formant\formant_chart_disyllable FirstSyllable.png"