...
FILTER_THRES = 0.95
SAMPLING_STEP = 0.01
MIN_MAX_PERCENT_CHANGE = [0.01, 0.4] # min max
MIN_MAX_PRESSURE = [9000, 14000]
RAMDOM_PARAM_NOISE_PROB = 0.00
SPEAKER_N = [0.0, 0.1, 0.2, 0.3, -0.1, -0.2, -0.3]
AUDIO_SAMPLE_RATE = 16000
GES_MIN_MAX_DURATION_DI = [0.65, 1.4] # min max
GES_MIN_MAX_DURATION_MONO = [0.5, 0.7] # min max
