...
// o laterality: Vector of degrees of laterality for the tube sections. 
...
C_EXPORT void vtlTubeSynthesisAdd(int numNewSamples, double *audio,
  double *tubeLength_cm, double *tubeArea_cm2, char *tubeArticulator,
  double *laterality, double incisorPos_cm, double velumOpening_cm2, 
  double aspirationStrength_dB, double *newGlottisParams);
...
/// o allValuesInRange: This value will be set to 1 if all values in the 
///   gestural score file are in the allowed range. The value will be set to 
///   0, if one or more values were out of the allowed range. In this case
///   the values are automatically constricted to the allowed range.
///
...
/// 4: Invalid wav-file name.
/// 5: The wav-file could not be saved.
// ****************************************************************************
